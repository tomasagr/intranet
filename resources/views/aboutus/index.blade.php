		...
		<div class="col-md-12">
			<div class="pearsons-list">
				...
				<div class="col-md-3 pearson text-center" ng-repeat="user in filteredUser = (users | filter:search)" style="height:350px;">
					<img  ng-if="user.avatar && user.avatar != 'null'"  class="img-responsive img-circle"  alt="" style="display: inline-block; width: 150px; height: 150px;background:url(/storage/@{{user.avatar}});background-size:cover; background-position:center">
